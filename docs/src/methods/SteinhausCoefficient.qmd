...
This page demonstrates the use of the Steinhaus coefficient in calculating community similarities between sets of site by species matrices.
...
Create a function to return the Steinhaus coefficient for two sites contained in a single matrix.
